...
#define COMMON_SETTINGS(M, ALIAS) \
    ...
    M(Bool, enable_one_nullable_key_aggregation_optimization, true, "Enable one nullable key aggregation optimization.", 0) \
    ...
    M(String, query_cache_expired_column, "", "Enable old data to set a longer ttl policy", 0) \
    M(UInt64, query_cache_expired_data_in_hour, 0, "The number of hours of data in the past is old data, 0 means that the data of the past hour is the old data of the query", 0) \
    ...
    M(Bool, is_only_write_leader_replica, false, "For UniqueMergeTree. only leader replica can be allowed for write.", 0)                                                                                                  \
